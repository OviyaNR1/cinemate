...
import BackImg from "../assets/images/backup.png"
...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchmovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=631a889cc4ec7cbd2413fbc8dc242b7c`);
