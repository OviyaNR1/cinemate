...
export const Header = () => {
  ...
  return (
    ...
    <header>
      <nav className="bg-white border-gray-200 border-b-2 rounded dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <img src={Logo} className="h-6 mr-2" alt="Cinemate Logo" />
            <span className="text-2xl self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Cinemate</span>
          </Link>

          <div id="Web-Nav" className="flex md:order-2">
